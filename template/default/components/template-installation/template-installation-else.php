...
<p><?php _e( '2. Navigate to the <strong>Appearance &gt; Themes section</strong> at the admin panel of the site and open the <Manualtrong>theme</strong> folder.' ); ?></p>
...
<p>
    ...
    <?php _e( 'After theme activation you will get a notice which offers you to install Cherry Theme Wizard plugin.
        To continue plugins and demo contents installation with Cherry Theme Wizard just hit <strong>Begin installing plugin</strong> link.
        You will be transfered to the page where you can select the needed plugins.'); ?>

</p>

<?php assets_manager()->get_image( 'assets/images/step1.png', 'img-preview', _( 'About' ) ); ?>

<p><?php _e( 'Then please click on <strong>Install</strong> link.' ); ?></p>


<?php assets_manager()->get_image( 'assets/images/step2.png', 'img-preview', _( 'About' ) ); ?>

<p>

    <?php _e( 'After Cherry Theme Wizard plugin has been successfully installed and activated click on <strong>Return to the Dashboard</strong> link.' ); ?>

</p>

<?php assets_manager()->get_image( 'assets/images/step3.png', 'img-preview', _( 'About' ) ); ?>


<h4><?php _e( 'Plugins Installation' ); ?></h4>

<p>
        <?php _e( 'After installation and activation Cherry Theme Wizard plugin you will get a notice which offers you to continue the plugins and demo contents installation with Cherry Theme Wizard.' ); ?>
        <?php _e( 'Then click on <strong>START INSTALL</strong> on the top of the page to start installation of the recommended plugins.' ); ?>
    </p>

<?php assets_manager()->get_image( 'assets/images/step4.png', 'img-preview', _( 'About' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/step5.png', 'img-preview', _( 'About' ) ); ?>
...
<blockquote class="alert alert-info">
       <p><?php _e( 'If your server configurations don\'t meet the WordPress minimal requirements and you couldn\'t install Full Version, try Lite one.' ); ?></p>
</blockquote>
...
<?php assets_manager()->get_image( 'assets/images/step8.png', 'img-preview', _( 'About' ) ); ?>

    <p>
        <?php _e( 'Red Install Plugin box means the installation process hasn\'t been completed. Press on <strong>Details</strong> link you will see where is the problem and please refer to ' ); ?>   <a href="https://support.template-help.com/"><?php _e( 'JetImpex Support department.' ); ?></a>
</p>


<?php assets_manager()->get_image( 'assets/images/step9.png', 'img-preview', _( 'About' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/tm-wizard8.png', 'img-preview', _( 'About' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/importing_sample_data2.png', 'img-preview', _( 'About' ) ); ?>

    <p>
       <?php _e( 'On this step Cherry Theme Wizard plugin regenerates thumbnails for all imported images. This process may take some minutes.' ); ?>
    </p>

<?php assets_manager()->get_image( 'assets/images/regenerate_thumbnails.png', 'img-preview', _( 'About' ) ); ?>

    <p>
       <?php _e( 'Import is finished. Cherry Theme Wizard plugin offers you to select options <strong>VIEW YOUR SITE</strong> or <strong>CUSTOMIZE YOUR THEME</strong>.' ); ?>
    </p>

<?php assets_manager()->get_image( 'assets/images/import_finished.png', 'img-preview', _( 'About' ) ); ?>
...
<div id="toc-manual-update" class="toc-id"></div>
<h3 id="manual-update"><?php _e( 'Manual Update' ); ?></h3>

<p><?php _e( 'Manually replacing your current version of Monstroid 2 with an updated version is as easy as 1-2-6! First off, you’ll need to download the updated version of the theme, which includes both the main theme and the child theme (which serves as a backup for all the custom changes you make to your styles etc).' ); ?>
</p>

<h5><?php _e( 'Next on, installing it, the child theme and export-import steps are due.' ); ?></h5>

<h5><?php _e( 'Export' ); ?></h5>

<ul class="marked-list">
    <li>
        <?php _e( 'Afterwards you’ll need to backup some of the settings, just in case:' ); ?>
        <p></p>
<ul>
            <p>
                <?php _e( '- backup the Customizer’s options. To do that go to your Monstroid <strong>Administration panel</strong> > then on your left go to the <strong>Customizing section > Export/Import > Export</strong> them;' ); ?>
            </p>
            <p>
                <?php _e( '- save the <strong>wp-content/themes/monstroid</strong> folder (duplicate it), just so it stays somewhere on your web server, let’s say in a folder named <strong>main monstroid backup</strong>.' ); ?>

            </p>
            </ul>

<?php assets_manager()->get_image( 'assets/images/man-update-1.png', 'img-preview', _( 'manual' ) ); ?>
...
<ul>
     <li>
        <?php _e( 'Afterwards proceed to the <strong>Appearance > Themes</strong>, switch to any other default Wordpress theme as your current one, and be sure to delete the Monstroid theme from that list.' ); ?>
    </li>

    <li>
        <?php _e( 'Returning now to the ZIP file of the updated version of the theme that you’ve downloaded previously, be sure to follow the following steps:' ); ?>
            <p>
                <?php _e( '- open the WordPress <strong>Administration panel</strong> and go to the <strong>Appearance > Themes</strong> section;' ); ?>
            </p>
            <p>
                <?php _e( '- click the <strong>Add new</strong> button and click <strong>Upload theme</strong>;' ); ?>
            </p>
             <p>
                <?php _e( '- after that, repeat the same steps for the Child theme, which you’ve previously unpacked from that same file as the main theme.' ); ?>
            </p>
        </ul>
    </li>
<ul>
    <li>
        <?php _e( 'After installing this updated Monstroid theme anew, proceed to update the Plugins, by going to the sidebar on your left > <strong>Updates</strong>.' ); ?>
    <p>
        <?php _e( 'Then  tick all the checkboxes for the listed plugins and click the <strong>Update All</strong> button at the top.' ); ?>
    </p>
</li>

<?php assets_manager()->get_image( 'assets/images/man-update-2.png', 'img-preview', _( 'manual' ) ); ?>
...
<h5>Import</h5>
    ...
    <li>
        <?php _e( 'Now you’ll need to import back those settings which you’ve exported in a previous step:' ); ?>
        <p></p>
            <p>
                 <?php _e( '- to do that go to your Monstroid admin dashboard > then on your left go to the <strong>Customizing</strong> section > <strong>Export/Import</strong>, and choose the Import option;' ); ?>
...
<?php assets_manager()->get_image( 'assets/images/man-update-3(1).png', 'img-preview', _( 'manual' ) ); ?>
...
<ul>
    ...
    <li>
         <?php _e( 'Following that, to save your custom styles, locate the <strong>main monstroid backup</strong> folder on your web server (1.2 in the list of steps) > Styles.CSS file > and copy those parts of the code that you’ve changed there into the Styles.CSS file that’s located in the new folder of an updated Monstroid version.' ); ?>
    </li>
</ul>
