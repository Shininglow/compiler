...
<p>
        <?php _e( 'After installation and activation TM Wizard plugin you will get a notice which offers you to continue the plugins and demo contents installation with TM Wizard.' ); ?>
...
<p><?php _e( 'If you need to install plugins manually, you can do this in two ways.' ); ?></p>

<h6><?php _e( 'The First Method' ); ?></h6>

<p><li><?php _e( 'Install plugins from <strong>theme/(your theme name)/assets/includes/plugins</strong>.' ); ?></li></p>

<h6><?php _e( 'The Second Method' ); ?></h6>
...
<?php assets_manager()->get_image( 'assets/images/pl1.png', 'img-preview', _( '' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/pl3.png', 'img-preview', _( '' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/pl2.png', 'img-preview', _( '' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/rename-dump-data-base.png', 'img-preview', _( '' ) ); ?>
...
<?php assets_manager()->get_image( 'assets/images/importing-data-base-panel.png', 'img-preview', _( '' ) ); ?>
