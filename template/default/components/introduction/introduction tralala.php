...
<h5 id="recommended-configuration"><?php _e( 'Recommended Configuration' ); ?></h5>
		...
		<p><?php printf( _( '1. In  define the following:' ), '<strong>php.ini</strong>' ); ?></p>

<pre class="unstyled" style= "background-color:#f9f9f9; line-height: 2px; height: 420px;">
...
<h1></h1>
	...
	<p>In the file <strong>wp-config.php</strong>, ‘set_time_limit’ =&gt; 60.</p>

</pre>
<p></p>

		<p><?php _e( '2. 50 MB of disk space.' ); ?></p>

		<p><?php _e( '3. Memory limit per process: 64mb (128mb or more recommended).' ); ?></p>
