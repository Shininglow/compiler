<div id="toc-the-events-calendar" class="toc-id"></div>
    <h3 id="the-events-calendar"><?php _e( 'Events List' ); ?></h3>

	<p>This widget displays the list of events with date, time, description, place and other informationon your site.</p>

<figure class="img-preview" style= "width:900px";><img src="<?php url_manager()->get_assets_url( 'assets/images/temp/the-events-calendar.png' ); ?>" alt="<?php _e( 'Events' ); ?>"></figure>
