...
<p><?php _e( 'Click the "Choose Media" button to select the logo image from the media library or upload your image.' ); ?></p>

<h5><?php _e( 'Retina Logo Upload' ); ?></h5>

<p><?php _e( 'Here you can upload the logo for retina-ready devices' ); ?></p>

<p> <?php _e( 'Upload invert logo. Displays only at style 1 header layout.' ); ?></p>

<p> <?php _e( 'Upload invert logo for retina-ready devices. Displays only at style 1 header layout. ' ); ?></p>
...
<h5><?php _e( 'Invert Logo Upload' ); ?></h5>

<p> <?php _e( 'Upload invert logo. Displays only at style 1 header layout.' ); ?></p>

<h5><?php _e( 'Invert Retina Logo Upload' ); ?></h5>
...
<h5><?php _e( 'Retina Invert Logo Upload' ); ?></h5>
