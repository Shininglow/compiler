...
<h5 id="help-and-support"><?php _e( 'JetImpex Support Portal' ); ?></h5>

<p>For more information please proceed to <a href="https://jetimpex.com/wordpress/" target="_blank">JetImpex Support Portal</a>. </p>

<h5 id="help-and-support"><?php _e( 'Ticket System' ); ?></h5>

<p> Depending on marketplace where you've purchased a template you can submit a ticket at:</p>
<ul>
<li> <a href="https://support.template-help.com/index.php?/Tickets/Submit" target="_blank">JetImpex</a>;</li>
...
<h5 id="help-and-support"><?php _e( 'Chat' ); ?></h5>

<p>If you've purchased a template at TemplateMonster.com marketplace, please, feel free to enter the <a href="https://chat.template-help.com/" target="_blank">chat</a>.
...
<ul>
	<li><a href="https://wordpress.org/plugins/creare-eu-cookie-law-banner/screenshots/"target="_blank"><?php _e( 'WP Cookie Banner;' ); ?></a></li>
	<li><a href="https://wordpress.org/plugins/cookie-banner/"target="_blank"><?php _e( 'Cookie Banner.' ); ?></a></li>
</ul>
...
=======
<ul>
	<li><a href="https://wordpress.org/about/"target="_blank"><?php _e( 'WordPress - Beginner’s Guide;' ); ?></a></li>
	<li><a href="https://codex.wordpress.org/FAQ"target="_blank"><?php _e( 'FAQ;' ); ?></a></li>
	<li><a href="https://codex.wordpress.org/Main_Page"target="_blank"><?php _e( 'WordPress Tutorials.' ); ?></a></li>
</ul>
...
<p>In case if you need more information regarding WordPress or any other issues, it can be found in the listed sources:</p>

<<<<<<< HEAD
<ul>
    <li><a href="https://jetimpex.com/wordpress/"target="_blank"><?php _e( 'JetImpex Support Portal;' ); ?></a></li>
	<li><a href="https://wordpress.org/about/"target="_blank"><?php _e( 'WordPress - Beginner’s Guide;' ); ?></a></li>
	<li><a href="https://codex.wordpress.org/FAQ"target="_blank"><?php _e( 'FAQ;' ); ?></a></li>
	<li><a href="https://codex.wordpress.org/Main_Page"target="_blank"><?php _e( 'WordPress Tutorials.' ); ?></a></li>
</ul>
...
<p><?php _e( 'Here you can view the latest updates for your theme.' ); ?></p>
