			...
			$this->menu_items = array(
				...
				'elementor' => array(
					...
					'child' => array(
						'general' => _( 'General' ),
						'sections' => _( 'Sections' ),
						'elementor-elements' => _( 'Elements' ),
					)

                    ),
				'elementor-modules' => array(
					'label' => _( 'Elementor Modules' ),
					'child' => array(
						'columns' => _( 'Columns' ),
						'heading' => _( 'Heading' ),
						'image' => _( 'Image' ),
						...
						'divider' => _( 'Divider' ),
						'spacer' => _( 'Spacer' ),
						'google-maps' => _( 'Google Maps' ),
						'icon' => _( 'Icon' ),
						'smart-slider' => _( 'Smart Slider' ),
						'image-box' => _( 'Image Box' ),
						'icon-box' => _( 'Icon Box' ),
						'image-gallery' => _( 'Image Gallery' ),
						'image-carousel' => _( 'Image Carousel' ),
						'icon-list' => _( 'Icon List' ),
						'counter' => _( 'Counter' ),
						'progress-bar' => _( 'Progress Bar' ),
						'testimonial' => _( 'Testimonial' ),
						'tabs' => _( 'Tabs' ),
						'accordion' => _( 'Accordion' ),
						'toggle' => _( 'Toggle' ),
						'social-icons' => _( 'Social Icons' ),
						'alert' => _( 'Alert' ),
						'soundcloud' => _( 'SoundCloud' ),
						'shortcode' => _( 'Shortcode' ),
						'html' => _( 'HTML' ),
						'menu-anchor' => _( 'Menu Ancor' ),
						'sidebar' => _( 'Sidebar' ),
						'cherry-projects' => _( 'Cherry Projects' ),
						'cherry-projects-terms' => _( 'Cherry Projects Terms' ),
						'cherry-timeline' => _( 'Cherry Timeline' ),
						'cherry-services' => _( 'Cherry Services' ),
						'advanced-carousel' => _( 'Advanced Carousel' ),
						'advanced-map' => _( 'Advanced Map' ),
						'brands' => _( 'Brands' ),
						'circle-progress' => _( 'Circle Progress' ),
						'posts' => _( 'Posts' ),
						'pricing-table' => _( 'Pricing Table' ),
						'cherry-team' => _( 'Cherry Team' ),
						'cherry-testi' => _( 'Cherry Testi' ),
						'slider' => _( 'Slider' ),
